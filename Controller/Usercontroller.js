...
const createUser = async (req, res) => {
    try {
        ...
        // Create new user in the database, allowing duplicates and blank entries
...
const updateUserTimes = async (req, res) => {
    try {
        ...
        const { inTimes, outTimes, totals, overtimes, days, weekNames, startTime, endTime } = req.body;
...
const updateUserOById = async (req, res) => {
    try {
        ...
        const { officeMode, description } = req.body;
